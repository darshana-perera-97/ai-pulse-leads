          ...
          <div className="relative px-6 sm:px-8 py-6 sm:py-7 border-b border-slate-200/70 bg-gradient-to-r from-slate-50/95 via-white to-indigo-50/25">
            ...
            <div className="relative flex flex-wrap items-start justify-between gap-4">
              ...
              <button
                ...
                onClick={refresh}
                disabled={loading}
                className="shrink-0 inline-flex items-center gap-2 rounded-2xl bg-indigo-600 px-5 py-2.5 text-xs font-semibold text-white transition hover:bg-indigo-700 disabled:opacity-60 disabled:pointer-events-none"
              >
                <svg
